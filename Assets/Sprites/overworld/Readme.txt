...
Extras/...
Guide.html			-Documentation on use and tips
...
OverworldTileset.unitypackage	-Unity example package. 
				 Example scene, Tile palette & animated tiles preconfigured.
				 Package created using Unity 2018.1.6, earlier versions
